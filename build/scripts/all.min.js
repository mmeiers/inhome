...
"use strict";$(function(){$("#keyboard").makeKeyboard(),(new SVGInjector).inject(document.querySelectorAll("svg[data-src]"))});
...
$(function(){function e(){if(""==$("input").val().trim())$(".error").fadeIn(200);else{$(".error").hide();var e=$("input").val(),t=$('<li class="todo">'+e+'<span class="item"><a href="#" class="check"><i class="material-icons">check</i></a><a href="#" class="delete-todo"><i class="material-icons">remove</i></a></span></li>');$(".todo-list").append(t);t.hide().fadeIn(500),$("input").val("").focus()}}$("i.fa-times").on("click",function(){$(".error").hide()}),$(".add-todo").on("click",e),$(document).on("keypress",function(t){13==t.which&&e()}),$(".clear-text").on("click",function(e){e.preventDefault(),$("input").val("").focus()}),$(document).on("click",".check",function(e){e.preventDefault(),$(this).closest("li").toggleClass("complete")}),$(document).on("click",".delete-todo",function(e){e.preventDefault(),$(this).closest("li").fadeOut(500,function(){$(this).remove()})})});
function getWeather(){$.simpleWeather({location:"66047",unit:"f",success:function(e){html='<li class="currently">'+e.currently+"</li>",html+='<h2><i class="icon-'+e.code+'"></i> '+e.temp+"&deg;"+e.units.temp+"</h2>",$("#weather").html(html)},error:function(e){$("#weather").html("<p>"+e+"</p>")}})}$(document).ready(function(){getWeather(),setInterval(getWeather,6e5)});