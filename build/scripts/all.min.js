...
function sketch(){var t=["#BC3A91","#0CA1EA","#30C5C2","#FFFFFF","#BC3A91"],e=0;Sketch.create({container:document.getElementById("sketch"),autoclear:!1,retina:"auto",setup:function(){console.log("setup")},update:function(){e=2+abs(50*sin(.003*this.millis))},keydown:function(){this.keys.C&&this.clear()},touchmove:function(){for(var i,n=this.touches.length-1;n>=0;n--)i=this.touches[n],this.lineCap="round",this.lineJoin="round",this.fillStyle=this.strokeStyle=t[n%t.length],this.lineWidth=e,this.beginPath(),this.moveTo(i.ox,i.oy),this.lineTo(i.x,i.y),this.stroke()}})}sketch(),$(".clear-button").click(function(){$("#sketch").empty(),sketch()});
